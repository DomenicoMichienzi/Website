...
<head>
  ...
  <link href="${pageContext.request.contextPath}/css/movies.css" rel="stylesheet">
  ...
  <div class="container">
    <div class="row justify-content-center justify-content-sm-start">
      <c:forEach items="${movies}" var="movie">
        <div class="col-auto d-flex align-items-start p-0" id="${movie.movie_id}">
          <div class="card w-100 border-0 my-2">
            <div class="card-body">
              <!-- Poster -->
              <div class="container movie-img-container m-0 p-1">
                <img src="${pageContext.request.contextPath}/assets/movies/posters/${movie.movie_id}.jpg"
                     class="card-img-top rounded shadow-sm" alt="...">
              </div>
              <!-- Title -->
              <p class="card-title mx-2 my-3 d-flex align-items-center">${movie.title}</p>
